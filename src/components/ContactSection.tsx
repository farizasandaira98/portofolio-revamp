			...
			<div className="section-scroll-container h-full overflow-y-auto py-8 sm:py-12 md:py-20 px-4 sm:px-6 lg:px-8">
				<div className="flex flex-col justify-center min-h-full">
					...
					<div className="absolute inset-0">
						{[...Array(15)].map((_, i) => (
							<motion.div
								key={`bg-animation-${i}-${Math.floor(Math.random() * 1000)}`}
										...
										<CardContent className="p-6 sm:p-8 flex flex-col h-full">
											...
											>
												...
												<p className="text-muted-foreground leading-relaxed">
													...
													opportunities and exciting projects. Whether you have
													a question or just want to say hi, feel free to reach
													out!
												</p>
											</motion.div>
												...
												>
													...
													>
														<Textarea
															...
															onChange={handleInputChange}
															placeholder={
																data.contact.form.placeholders.message
															}
															required
