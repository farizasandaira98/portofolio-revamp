...
// Language store
export const language    // Form Messages
    thankYouMessage: 'Thanks {name}! Your message has been received. I will get back to you soon.', writable('en'); // 'en' or 'id'
...
export const translations = {
  en: {
    ...
    // Form Messages
    thankYouMessage: 'Thanks {name}! Your message has been received. I'll get back to you soon.',
