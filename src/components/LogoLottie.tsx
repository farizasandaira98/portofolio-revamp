    ...
    >
      ...
      <div className="relative flex items-center justify-center">
        <svg viewBox="0 0 120 40" className="w-full h-full">
          {/* Background gradient */}
          <defs>
            <linearGradient id="staticLogoGradient" x1="0%" y1="0%" x2="100%" y2="100%">
              <stop offset="0%" stopColor="currentColor" stopOpacity="0.1" />
              <stop offset="50%" stopColor="currentColor" stopOpacity="0.05" />
              <stop offset="100%" stopColor="currentColor" stopOpacity="0.1" />
            </linearGradient>
            <linearGradient id="staticTextGradient" x1="0%" y1="0%" x2="100%" y2="0%">
          ...
          {/* Background shape */}
          <rect
            x="2" y="2" width="116" height="36" rx="8"
          ...
          <circle cx="15" cy="8" r="2" fill="url(#staticTextGradient)" opacity="0.6" />
          <circle cx="105" cy="16" r="2" fill="url(#staticTextGradient)" opacity="0.6" />
          <circle cx="195" cy="24" r="2" fill="url(#staticTextGradient)" opacity="0.6" />
        </svg>
      </div>
    </div>
  );
  ...
  return (
    ...
    >
      <svg viewBox="0 0 40 40" className="w-full h-full">
        ...
        {/* Inner elements */}
        <circle cx="20" cy="20" r="6" fill="url(#plainGradient)" opacity="0.6" />
